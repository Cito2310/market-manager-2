...
import { setCurrentModal, setNoneModal } from "../../../../store/modal/modalSlice"
...
export const ModalAddImage = () => {
    ...
    const handleImageUpload = async( base64: string, nameImage: string ) => {
        try {
    ...
    const onSubmit = async() => {
        await handleImageUpload( addImageData!.base64, getValues("name") );
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
                <Layout.Column className="w-full">
                    {/* BODY */}
                    <InputModal placeholder="Nombre de la imagen" register={register("name")} />
